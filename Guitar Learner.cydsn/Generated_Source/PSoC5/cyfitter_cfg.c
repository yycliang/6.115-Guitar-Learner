...
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x480002F8u)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x4800030Cu)
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE ADC_SOUND_IN_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADC_SOUND_IN_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: ADC_SOUND_IN_AMux_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void ADC_SOUND_IN_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_SOUND_IN_AMux__addrTable[channel] |= ADC_SOUND_IN_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: ADC_SOUND_IN_AMux_Unset
********************************************************************************
* Summary:
*  This function is used to clear a particular channel from being active on the
*  AMux.
...
*
*******************************************************************************/
void ADC_SOUND_IN_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_SOUND_IN_AMux__addrTable[channel] &= (uint8)~ADC_SOUND_IN_AMux__maskTable[channel];
	}
}
